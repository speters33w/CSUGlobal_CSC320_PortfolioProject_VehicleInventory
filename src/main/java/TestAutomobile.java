...
/**
 * 1. Create an additional class to call your automobile class (e.g., Main or edu.csuglobal.AutomobileInventory).
...
public class TestAutomobile {
    public static void main(String[] args) {
        ...
        System.out.println("\nCreate an additional class to call your automobile class (e.g., Main or edu.csuglobal.AutomobileInventory).");
        edu.csuglobal.AutomobileInventory automobileInventory = new edu.csuglobal.AutomobileInventory();

        System.out.println("\nCall automobile class with parameterized constructor (e.g., \"make, model, color, year, mileage\").");
        edu.csuglobal.Automobile automobile = new edu.csuglobal.Automobile("1C6RD7LT6CS320434", "Dodge", "Ram 1500 BigHorn",
        ...
        System.out.println("\nAdd a new vehicle.");
        automobile = new edu.csuglobal.Automobile("1GTR9CED7KZ251641", "GMC", "Sierra",
